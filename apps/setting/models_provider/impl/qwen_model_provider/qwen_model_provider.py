...
model_dict = {
    ...
    'qwen2-57b': ModelInfo('qwen2-57b-a14b-instruct', '', ModelTypeConst.LLM, qwen_model_credential),
    'qwen2-72b': ModelInfo('qwen2-72b-instruct', '', ModelTypeConst.LLM, qwen_model_credential)
}
...
class QwenModelProvider(IModelProvider):
    ...
    def get_model_provide_info(self):
        return ModelProvideInfo(provider='model_qwen_provider', name='通义千问/Tongyi Qianwen', icon=get_file_content(
